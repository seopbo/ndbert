...
parser.add_argument(
    "--data_dir", default="trec", help="directory containing config.json of data"
)
parser.add_argument(
    "--model_dir",
    default="experiments/trec",
...
parser.add_argument(
    "--dataset",
    default="val",
    help="name of the data in_tagging --data_dir to be evaluate",
)
...
if __name__ == "__main__":
    ...
    summary_manager.update({"{}".format(args.dataset): summ})
